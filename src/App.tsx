...
function App() {
  ...
  const contract = "8xhe7UwgMXqKhxQCcPJ7aJbQXdFmKbGpqtxXEw";
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-8">
              ...
              <div className="hidden md:flex items-center space-x-8">
                <a href="#home" className="hover:text-[#22D1F8] transition-colors">Home</a>
                  ...
                  {isSocialOpen && (
                    <div className="absolute top-full left-0 mt-2 w-48 bg-[#181F35] border border-[#22D1F8]/20 rounded-lg shadow-xl">
                      <a href="https://t.me/pixelpoint" target="_blank" rel="noopener noreferrer" 
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-[#22D1F8]/10">
                        <span>Telegram</span>
                        <ExternalLink className="w-4 h-4" />
                      </a>
                      <a href="https://twitter.com/pixelpoint" target="_blank" rel="noopener noreferrer"
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-[#22D1F8]/10">
                        <span>Twitter</span>
                        <ExternalLink className="w-4 h-4" />
                      </a>
                      <a href="https://dexscreener.com/pixelpoint" target="_blank" rel="noopener noreferrer"
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-[#22D1F8]/10">
                        <span>Dex Screener</span>
                        <ExternalLink className="w-4 h-4" />
                      </a>
                      <a href="https://coinmarketcap.com/pixelpoint" target="_blank" rel="noopener noreferrer"
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-[#22D1F8]/10">
                        <span>CoinMarketCap</span>
                        <ExternalLink className="w-4 h-4" />
                      </a>
                      <a href="https://coingecko.com/pixelpoint" target="_blank" rel="noopener noreferrer"
                        className="flex items-center space-x-2 px-4 py-2 hover:bg-[#22D1F8]/10">
                        <span>CoinGecko</span>
                        <ExternalLink className="w-4 h-4" />
                      </a>
